...
const ProblemSection = () => {
  const problems = [
    { icon: TrendingDown, text: "{{problem1}}" },
    { icon: Clock, text: "{{problem2}}" },
    { icon: Target, text: "{{problem3}}" },
    { icon: AlertCircle, text: "{{problem4}}" },
    { icon: TrendingDown, text: "{{problem5}}" }
  ];
    ...
    <section className="py-12 lg:py-20 relative">
      <div className="container-custom text-center">
        <h2 className="text-h2 text-white mb-6 lg:mb-8">
          {{problemSectionTitle}} <span className="bg-gradient-to-r from-[#FF6B6B] to-[#FF8E53] bg-clip-text text-transparent font-bold">{{problemSectionHighlight}}</span>?
        </h2>
