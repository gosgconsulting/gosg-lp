...
export const SpartiToolbar: React.FC = () => {
  const { isEditing, config, enterEditMode, exitEditMode, saveChanges } = useSpartiBuilder();
        ...
        <div className="sparti-toolbar-actions">
          {!isEditing ? (
            ...
            <>
              ...
              <button className="sparti-btn sparti-btn-success" title="Save Changes" onClick={saveChanges}>
                <Save size={16} />
                Save
              </button>
              <button 
